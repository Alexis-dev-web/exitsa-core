...
class UserViewTest(BaseCase):
    ...
    @patch('rest_framework_simplejwt.authentication.JWTAuthentication.authenticate')
    def test_save_user_first_name_required(self, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
    ...
    @patch('rest_framework_simplejwt.authentication.JWTAuthentication.authenticate')
    def test_save_user_last_name_required(self, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
        json_request = self.dummy_data.build_basic_request()
    ...
    @patch('rest_framework_simplejwt.authentication.JWTAuthentication.authenticate')
    def test_save_user_email_required(self, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
        json_request = self.dummy_data.build_basic_request()
    ...
    @patch('rest_framework_simplejwt.authentication.JWTAuthentication.authenticate')
    def test_save_user_invalid_email(self, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
        json_request = self.dummy_data.build_basic_request()
    ...
    @patch('rest_framework_simplejwt.authentication.JWTAuthentication.authenticate')
    def test_save_user_password(self, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
        json_request = self.dummy_data.build_basic_request()
    ...
    @patch('rest_framework_simplejwt.authentication.JWTAuthentication.authenticate')
    def test_save_user_confirm_password(self, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
        json_request = self.dummy_data.build_basic_request()
    ...
    @patch('rest_framework_simplejwt.authentication.JWTAuthentication.authenticate')
    def test_save_user_gender_required(self, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
        json_request = self.dummy_data.build_basic_request()
    ...
    @patch('rest_framework_simplejwt.authentication.JWTAuthentication.authenticate')
    def test_save_user_gender_invalid(self, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
        json_request = self.dummy_data.build_basic_request()
    ...
    @patch('rest_framework_simplejwt.authentication.JWTAuthentication.authenticate')
    def test_save_user_group_required(self, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
        json_request = self.dummy_data.build_basic_request()
    ...
    @patch('rest_framework_simplejwt.authentication.JWTAuthentication.authenticate')
    def test_save_user_birthday_invalid_format(self, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
        json_request = self.dummy_data.build_basic_request()
    ...
    @patch('rest_framework_simplejwt.authentication.JWTAuthentication.authenticate')
    def test_save_user_passwords_not_match(self, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
        json_request = self.dummy_data.build_basic_request()
    ...
    def test_save_user_user_already_exists(self, mock_user_email, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
        json_request = self.dummy_data.build_basic_request()
    ...
    def test_successful_save(self, mock_save_user, mock_user_email, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
        json_request = self.dummy_data.build_basic_request()
        second_user = self.dummy_data.build_user_test('test2@exitosa.test')
    ...
    @patch('rest_framework_simplejwt.authentication.JWTAuthentication.authenticate')
    def test_update_user_first_name_required(self, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
        json_request = self.dummy_data.build_basic_request()
    ...
    @patch('rest_framework_simplejwt.authentication.JWTAuthentication.authenticate')
    def test_update_user_last_name_required(self, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
        json_request = self.dummy_data.build_basic_request()
        json_request['user_id'] = str(uuid.uuid4())
        json_request.pop('last_name', None)
    ...
    @patch('rest_framework_simplejwt.authentication.JWTAuthentication.authenticate')
    def test_update_user_email_required(self, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
        json_request = self.dummy_data.build_basic_request()
        json_request['user_id'] = str(uuid.uuid4())
        json_request.pop('email', None)
    ...
    @patch('rest_framework_simplejwt.authentication.JWTAuthentication.authenticate')
    def test_update_user_invalid_email(self, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
        json_request = self.dummy_data.build_basic_request()
        json_request['email'] = 'myemail'
        json_request['user_id'] = str(uuid.uuid4())
    ...
    @patch('rest_framework_simplejwt.authentication.JWTAuthentication.authenticate')
    def test_update_user_gender_required(self, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
        json_request = self.dummy_data.build_basic_request()
        json_request['user_id'] = str(uuid.uuid4())
        json_request.pop('gender', None)
    ...
    @patch('rest_framework_simplejwt.authentication.JWTAuthentication.authenticate')
    def test_update_user_gender_invalid(self, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
        json_request = self.dummy_data.build_basic_request()
        json_request['user_id'] = str(uuid.uuid4())
        json_request['gender'] = 'P'
    ...
    @patch('rest_framework_simplejwt.authentication.JWTAuthentication.authenticate')
    def test_update_user_birthday_invalid_format(self, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
        json_request = self.dummy_data.build_basic_request()
        json_request['birthday'] = '01-02-2024'
        json_request['user_id'] = str(uuid.uuid4())
    ...
    @patch('rest_framework_simplejwt.authentication.JWTAuthentication.authenticate')
    def test_update_user_id_required(self, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
        json_request = self.dummy_data.build_basic_request()
    ...
    def test_save_user_user_not_exists(self, mock_user_get_by_id, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
        json_request = self.dummy_data.build_basic_request()
        json_request['user_id'] = str(uuid.uuid4())
    ...
    @patch('user.models.UserRepository.get_by_id')
    @patch('user.models.UserRepository.get_by_email')
    def test_update_user_user_not_exists(self, mock_get_by_email, mock_user_get_by_id, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
        json_request = self.dummy_data.build_basic_request()
        second_user = self.dummy_data.build_user_test('test2@exitosa.test')
    ...
    @patch('user.models.UserRepository.get_by_email')
    @patch('user.models.User.save')
    def test_successful_update(self, mock_save_user, mock_get_by_email, mock_user_get_by_id, mock_authenticate):
        user_login = self.dummy_data.build_user_test()
        json_request = self.dummy_data.build_basic_request()
        second_user = self.dummy_data.build_user_test('test2@exitosa.test')
        json_request['user_id'] = str(second_user.id)
